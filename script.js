const accessKey = "OCaVBr-yeVVJaYJDRBCpfrGGRdoxdJKW4wNmo3yaUvI";
...
async function searchImages(){
    ...
    results.map((result) =>{
        ...
        imagWrapper.classList.add("col-sm-6");  
        imagWrapper.classList.add("col-md-4");  
        imagWrapper.classList.add("col-lg-4");  
